...
// Zone 2 Meetings
// var addressesForDb = JSON.parse(fs.readFileSync('data/address2.json'));
// id = 1
...
// // Zone 1 Meetings
// var addressesForDb = JSON.parse(fs.readFileSync('data/address1.json'));
// id = 30
// async.eachSeries(addressesForDb, function(value, callback) {
...
// // Zone 5 Meetings
// var addressesForDb = JSON.parse(fs.readFileSync('data/address5.json'));
// id = 80
// async.eachSeries(addressesForDb, function(value, callback) {
