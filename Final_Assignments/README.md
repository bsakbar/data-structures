...
```
In my case, the original written data looked like [this](https://github.com/bsakbar/data-structures/blob/master/week9/test.json), but I wanted to abstract the data so I calculated the average/hour instead of every 5 minutes. Here how it looks now:
```
[
    {
        value: "1308",
